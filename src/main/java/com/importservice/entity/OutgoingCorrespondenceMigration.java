...
@Entity
@Table(name = "outgoing_correspondence_migrations", indexes = {
    @javax.persistence.Index(name = "idx_outgoing_corr_guid", columnList = "correspondence_guid"),
    @javax.persistence.Index(name = "idx_outgoing_current_phase", columnList = "current_phase"),
    @javax.persistence.Index(name = "idx_outgoing_overall_status", columnList = "overall_status"),
    @javax.persistence.Index(name = "idx_outgoing_phase_status", columnList = "phase_status"),
    @javax.persistence.Index(name = "idx_outgoing_creation_status", columnList = "creation_status"),
    @javax.persistence.Index(name = "idx_outgoing_assignment_status", columnList = "assignment_status"),
    @javax.persistence.Index(name = "idx_outgoing_approval_status", columnList = "approval_status"),
    @javax.persistence.Index(name = "idx_outgoing_business_log_status", columnList = "business_log_status"),
    @javax.persistence.Index(name = "idx_outgoing_comment_status", columnList = "comment_status"),
    @javax.persistence.Index(name = "idx_outgoing_closing_status", columnList = "closing_status"),
    @javax.persistence.Index(name = "idx_outgoing_need_to_close", columnList = "is_need_to_close"),
    @javax.persistence.Index(name = "idx_outgoing_retry_count", columnList = "retry_count"),
    @javax.persistence.Index(name = "idx_outgoing_last_modified", columnList = "last_modified_date"),
    @javax.persistence.Index(name = "idx_outgoing_created_doc_id", columnList = "created_document_id"),
    @javax.persistence.Index(name = "idx_outgoing_retryable", columnList = "phase_status, retry_count"),
    @javax.persistence.Index(name = "idx_outgoing_closing", columnList = "is_need_to_close, created_document_id, closing_status")
})
public class OutgoingCorrespondenceMigration {
    ...
    // Constructors
    public OutgoingCorrespondenceMigration() {}
    
    public OutgoingCorrespondenceMigration(String correspondenceGuid, Boolean isNeedToClose) {
